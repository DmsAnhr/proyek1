        ...
        <div class="container">
            <div class="row contact-top-cover">
                <div class="col-12 col-lg-6 contact-img">
                    <img src="{{asset ('assets/user/img/cont-img-1.jpg')}}" alt="img">
                </div>
                <div class="col-12 col-lg-6 contact-info">
                    <h2 class="title">Contact Information</h2>
                    <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit <a
                            href="#">totam rem</a> aperiam, eaque sed quia non numquam eius modi tempora incidunt ut
                        labore et dolore magnam aliquam.</p>
                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,
                        totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae
                        dicta sunt explicabo. Nemo enim Nor again is there anyone who loves or pursues or desires to obtain.
                    </p>
        ...
        <div class="container">
            <div class="row contacts-block">
                <div class="col-12 col-md-4">
                    <div class="contact-block-item">
                        <div class="contact-block-left">
                            <img src="{{asset ('assets/user/img/cont-icon-1.svg')}}" alt="img">
                            <h6>need help</h6>
                        </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="contact-block-item">
                        <div class="contact-block-left">
                            <img src="{{asset ('assets/user/img/cont-icon-2.svg')}}" alt="img">
                            <h6>questions</h6>
                        </div>
                        <div class="contact-block-right">
                            <ul>
                ...
                <div class="col-12 col-md-4">
                    <div class="contact-block-item">
                        <div class="contact-block-left">
                            <img src="{{asset ('assets/user/img/cont-icon-3.svg')}}" alt="img">
                            <h6>address</h6>
                        </div>
                        <div class="contact-block-right">
                            <ul>
