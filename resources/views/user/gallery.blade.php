                ...
                <div class="grid-gallery">
                    ...
                    <div class="gallery-item gallery-item-big">
                        <a href="assets/img/gal-1.jpg" data-fancybox="gallery1">
                            <img src="{{asset ('assets/user/img/gal-1.jpg')}}" alt="img">
                            <div class="gal-item">
                    ...
                    <div class="gallery-item">
                        <a href="assets/img/gal-2.jpg" data-fancybox="gallery1">
                            <img src="{{asset ('assets/user/img/gal-2.jpg')}}" alt="img">
                            <div class="gal-item">
                    ...
                    <div class="gallery-item">
                        <a href="assets/img/gal-3.jpg" data-fancybox="gallery1">
                            <img src="{{asset ('assets/user/img/gal-3.jpg')}}" alt="img">
                            <div class="gal-item">
                    ...
                    <div class="gallery-item">
                        <a href="assets/img/gal-4.jpg" data-fancybox="gallery1">
                            <img src="{{asset ('assets/user/img/gal-4.jpg')}}" alt="img">
                            <div class="gal-item">
                    ...
                    <div class="gallery-item gallery-item-big">
                        <a href="assets/img/gal-5.jpg" data-fancybox="gallery1">
                            <img src="{{asset ('assets/user/img/gal-5.jpg')}}" alt="img">
                            <div class="gal-item">
                    ...
                    <div class="gallery-item gallery-item-big">
                        <a href="assets/img/gal-6.jpg" data-fancybox="gallery1">
                            <img src="{{asset ('assets/user/img/gal-6.jpg')}}" alt="img">
                            <div class="gal-item">
                    ...
                    <div class="gallery-item">
                        <a href="assets/img/gal-7.jpg" data-fancybox="gallery1">
                            <img src="{{asset ('assets/user/img/gal-7.jpg')}}" alt="img">
                            <div class="gal-item">
                    ...
                    <div class="gallery-item">
                        <a href="assets/img/gal-8.jpg" data-fancybox="gallery1">
                            <img src="{{asset ('assets/user/img/gal-8.jpg')}}" alt="img">
                            <div class="gal-item">
                    ...
                    <div class="gallery-item">
                        <a href="assets/img/gal-9.jpg" data-fancybox="gallery1">
                            <img src="{{asset ('assets/user/img/gal-9.jpg')}}" alt="img">
                            <div class="gal-item">
