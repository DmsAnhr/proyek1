...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row about-adv-cover">
                <div class="cil-12 col-md-6 about-adv-item">
                    <img src="{{asset ('assets/user/img/about-1.jpg')}}" alt="img">
                    <h5 class="title">Doloremque laudantium, totam rem aperiam</h5>
                    <p>Sed ut perspiciatis unde omnis iste natus sit voluptatem accusantium doloremque lauda ntium, <a
                            href="#">totam rem</a> aperiam, eaque.</p>
                </div>
                <div class="cil-12 col-md-6 about-adv-item">
                    <img src="{{asset ('assets/user/img/about-2.jpg')}}" alt="img">
            ...
            <div class="our-advantages-wrap advantages-wrap-about">
                ...
                <div class="our-advantages-item wow fadeInUp" data-wow-duration=".6s" data-wow-delay=".45s">
                    <img src="{{asset ('assets/user/img/advantages-about-4.svg')}}" alt="icon">
    ...
    <!--================= S-ABOUT-COUNT =================-->
    <section class="s-about-count counter-animate counter-active"
        style="background-image: url(assets/img/bg-about-count.jpg);">
        ...
        <div class="container">
            ...
            <div class="row team-cover">
                <div class="col-sm-6 col-md-3 team-item">
                    <img src="{{asset ('assets/user/img/about-team-1.jpg')}}" alt="img">
                ...
                <div class="col-sm-6 col-md-3 team-item">
                    <img src="{{asset ('assets/user/img/about-team-2.jpg')}}" alt="img">
                ...
                <div class="col-sm-6 col-md-3 team-item">
                    <img src="{{asset ('assets/user/img/about-team-3.jpg')}}" alt="img">
                ...
                <div class="col-sm-6 col-md-3 team-item">
                    <img src="{{asset ('assets/user/img/about-team-4.jpg')}}" alt="img">
