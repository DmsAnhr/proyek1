                        ...
                        <ul class="nav nav-tabs" id="tab_checkout" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#tab_1" role="tab"
                                    aria-controls="tab_1" aria-selected="true">Address</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#tab_2" role="tab"
                                    aria-controls="tab_2" aria-selected="false">Other</a>
                            </li>
                        </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="step middle payments">
                        ...
                        <ul>
                            ...
                            <li>
                                <label class="container_radio">E-Wallet<a href="#0" class="info"
                                        data-bs-toggle="modal" data-bs-target="#payments_method"></a>
                            ...
                            <li>
                                <label class="container_radio">Cash on delivery (COD)<a href="#0" class="info"
                                        data-bs-toggle="modal" data-bs-target="#payments_method"></a>
                        ...
                        <ul>
                            <li>
                                <label class="container_radio">Self Pickup<a href="#0" class="info"
                                        data-bs-toggle="modal" data-bs-target="#payments_method"></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="step last">
                        ...
                        <div class="box_general summary">
                            ...
                            <ul>
                                <li class="clearfix subtotal" subtotal=""><em><strong>Subtotal</strong></em> <span>Rp.
                                        0</span></li>
                                <li class="clearfix hari" hari=""><em><strong>Lama</strong></em> <span>1
                                        Hari</span></li>
                                <li class="clearfix shipping" shipping="0"><em><strong>Shipping</strong></em> <span>Rp.
                                        0</span></li>
...
@push('js')
    ...
    <script>
        ...
        function changeTotal() {
            ...
            $('.subtotal').attr('subtotal', total).html('<em><strong>Subtotal</strong></em>  <span>' + formatRupiah(total,
                'Rp. ') + '</span>');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(cartItems, function(index, item) {
                    ...
                    var html = '<li class="clearfix item-co"  barang-id="' + item.barang.id +
                        '" barang-jumlah="' + item.jumlah + '"><em>' + item.jumlah + 'x ' + item.barang
                        .nama + '</em>  <span class="subtotal-barang" data-subtotal="' + subTotal +
                        '">' + formatRupiah(subTotal, 'Rp. ') + '</span></li>';
