                    ...
                    <div class="all">
                        <div class="slider">
                            <div class="owl-carousel owl-theme main">
                                <div style="background-image: url(assets/userNew/img/blog-thumb-placeholder.jpg);"
                                    class="item-box">
                                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="prod_info">
                        ...
                        <span class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i
                                ...
                                reviews</em></span>
                        <p><small>SKU: MTKRY-001</small><br>Keterangan</p>
...
@push('css')
    <!-- SPECIFIC CSS -->
    <link href="{{ asset('assets/userNew/css/product_page.css') }}" rel="stylesheet">
@endpush
...
@push('js')
    ...
    <script>
        ...
        var idURL = url.match(/product=(\d+)/);
        var idBarang = idURL[1];

        $.ajax({
            url: "/single-product/" + idBarang,
            type: "GET",
            dataType: "json",
            success: function(response) {
                ...
                var barang = response;
                $('.owl-item.active div').css('background-image', 'url(storage/' + barang.foto + ')')
                $('.prod_info h1').text(barang.nama);
